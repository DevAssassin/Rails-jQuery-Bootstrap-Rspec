class Sport::Basketball < Recruit
  ...
  ProjectedPositions = ["Point Guard", "Guard", "Guard/Forward", "Forward", "Center"]
  SecondaryPositions = ["Point Guard", "Guard", "Guard/Forward", "Forward", "Center"]
